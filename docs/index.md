...
features:
  - title: Baseline vs. Variants
    details: Define a baseline and any number of variants -- different skills, models, prompts, or configs -- and run them against the same tasks.
