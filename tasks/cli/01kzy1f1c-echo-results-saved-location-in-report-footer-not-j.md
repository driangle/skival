...
- [ ] Add the results-dir / results-saved location to the report footer.
- [ ] Keep the existing stderr line as-is (this is additive, not a move).
- [ ] Update report tests/snapshots to include the footer path.
